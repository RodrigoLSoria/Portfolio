        ...
        <>
            <Row className='navi justify-content-between align-items-center' role="navigation" aria-label={language === 'ENG' ? 'Main Navigation' : 'Navegación Principal'}>
                <Col xs='3' lg='3'>
                    <div className={`nav-head ${scrolling ? 'scroll-down' : ''}`}>
                        <a href="#intro-blank-section"> <h3><span>Rodrigo.</span></h3> </a>
                    </div>
                </Col>
                <Col xs='8' lg='6'>
                ...
                <Col xs='2' lg='1' className='logo-contact text-end'>
                    <a href='https://github.com/RodrigoLSoria' target='_blank'><img className='me-2' src="https://res.cloudinary.com/dbtmrinwa/image/upload/v1697055951/xbuhmypxuxhnni2itq3l.png" alt="GitHub Icon" role="img" aria-label="GitHub Profile" /></a>
                    <a href='https://www.linkedin.com/in/rodrigo-l%C3%B3pez-soria-58a6291a5/' target='_blank'><img src="https://res.cloudinary.com/dbtmrinwa/image/upload/f_auto,q_auto/qktqnj646lv6ix3uwafy" alt="LinkedIn Icon" role="img" aria-label="LinkedIn Profile" /></a>
                </Col>
            ...
            <nav className="nav" role="navigation" aria-label={language === 'ENG' ? 'Mobile Navigation' : 'Navegación Móvil'}>
                <ul>
                    ...
                    <li>
                        <a href='https://github.com/RodrigoLSoria' target='_blank' onClick={closeMenu} role="menuitem">
                    ...
                    <li>
                        <a href='https://www.linkedin.com/in/rodrigo-l%C3%B3pez-soria-58a6291a5/' target='_blank' role="menuitem">
